export function createSSETransformContext(logger) {
    return {
...
export function createSSETransformStream(ctx) {
    let accumulatedText = "";
                ...
                try {
                    ...
                    if (toolCalls && Array.isArray(toolCalls)) {
                        for (const tc of toolCalls) {
                            ...
                            const tcId = tc.id ?? `call_${Date.now().toString(36)}_${tcIndex}`;
